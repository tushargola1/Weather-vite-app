...
const Herosection = ({ city }) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        // const response = await axios.get(`${url}q=${city}&appid=${apiKey}`, { signal });
  ...
  setIcon(clear_sky);
        ...
        const formattedSunrise = rise.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });
        const formattedSunset = set.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });
